section .data
		msg1 db "Hello, World!",10,0 ; with NL and 0
		msg1Len equ $-msg1-1 ;measure the length, minus the 0
							 ;take this memory location ($) and
							 ;subtract the memory location of msg1.
							 ;The result is the length of msg1
		msg2 db	"Alive and Kicking!",10,0 ; with NL and 0
